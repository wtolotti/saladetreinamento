<?php echo $header; ?>
<script>
  window.rawData = {checkout:{items:[]}};
  rawData.checkout.productsTotal = 0;
  rawData.checkout.grandTotal = 0;
  window.step = "Cart";
</script>
<div class="container">
  <ul class="breadcrumb">
        ...
        <div class="table-responsive">
          <table class="table table-bordered">
            ...
            <tbody>
              ...
              <script>
                var baseP = '<?php echo $product['price'];?>';
                var saleP = '<?php echo $product['price'];?>';
                baseP = baseP ? Number(baseP.replace(/[^0-9\.]+/g,"")) : false;
                saleP = saleP ? Number(saleP.replace(/[^0-9\.]+/g,"")) : false;
                rawData.checkout.items.push({
                      sku: '<?php echo $product['product_id'];?>',
                      name: removeErrorText('<?php echo $product['name'];?>'),
                      basePrice: baseP,
                      salePrice: saleP,
                      discount: (saleP ? baseP - saleP : false),
                })
                rawData.checkout.productsTotal += baseP;
                rawData.checkout.grandTotal += saleP;
              </script>
              <tr>
